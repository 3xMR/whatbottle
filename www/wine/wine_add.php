...
//clear wine session before loading page
unset($_SESSION['var_wine_temp']);
$_SESSION['var_wine_temp']['status'] = 1 //new wine
        ...
        echo "<div class=\"con_title_bar\" >";
            ...
            echo "<div style=\"border-bottom: solid 1px darkgray; padding-bottom:5px; margin-top:5px; margin-bottom:5px;\" >";
                ...
                echo "<div style=\"width:auto; float:left; padding-top:5px;\" >";
                    echo "<h1 class=\"inline\" style=\"padding-top:10px;\" >Add New Wine</h1>";
                echo "</div>";
...
$(document).ready(function(){
    ...
    function initialise_page(){
       ...
       console.log('initialise page...');
        ...
        initialise_listBox_region(); //select location pop-up
    ...
    function producerSelected(){
        ...
        if(producer_id > 0){
            //get count of wines for producer, and update wine session to that producer_id is updated
            $.when( getWinesForProducerCount(producer_id), putWineServer() ).then(
                function(count){
                    if(count>0){
                        ...
                        console.log('show wines for producer');
                    }else{
   ...
   function putProducerToSession(){
       //update session with producer_id so that php pages can
   }
...
//*** Menus ***
    ...
    function initialise_listBox_region(){
        //function to allow listBox to be initialised after loading from jquery loaded rpc_wine_form_html
        
        //setup region listBox
        $("#con_listBox_region").listBox({
            title: "Region",
            width: '400px',
    ...
    function updateRegion(){
        //update country, region, subregion from listBox selection
        
        var data = objLocation;
    ...
    function showLocationDialog(){
        ...
        $("#dialog-location-select").dialog({
            ...
            dialogClass: "clean-dialog",
            position: { my: "left bottom", at: "left top", of: '#location' }
        });   
